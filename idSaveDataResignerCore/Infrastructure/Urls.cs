...
public static class Urls
{
    ...
    public const string ProjectsRepo = "https://github.com/mi5hmash/idSaveDataResigner";
    ...
    public static void OpenSteamStoreProductPage(uint appId) => OpenUrl($"{SteamStoreBaseUrl}/{appId}");
