...
public partial class MainWindowViewModel : ObservableValidator
{
    ...
    private void LoadGameProfileFile(string path)
    {
        ...
        try { GameProfileManager.Load(path); }
            ...
            GameProfileAppId = $"App ID: {GameProfileManager.GameProfile.AppId ?? string.Empty}";
        }
    }
    ...
    [RelayCommand]
    // TODO: Select Store Based on Gaming Platform
    private void VisitSteamStoreProductPage() 
        => Urls.OpenSteamStoreProductPage(Convert.ToUInt32(GameProfileManager.GameProfile.AppId));
    #endregion
